...
if ($ADMIN->fulltree) {
    ...
    // Course description image background setting
    $name = 'theme_remui/coursedescimage';
    $title = get_string('coursedescimage', 'theme_remui');
    $description = get_string('coursedescimagedesc', 'theme_remui');
    $default = false;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
